...
// --------------------------------------------------------------------------------------
{
    ...
    c0 = MAX3(a00, a10, a20); c1 = MAX3(a01, a11, a21);
...
// ------------------------------------------------------------------------------------------------
{
    ...
    */
    ...
    c00 = MAX3(a00, a10, a20); c10 = MAX3(a01, a11, a21);
    c01 = MAX3(a10, a20, a30); c11 = MAX3(a11, a21, a31);
...
// -----------------------------------------------------------------------------------------------------------
{
    ...
    for (i = i0; i <= ((i1 - 1) - r); i += 2)
    {
        line_dilatation3_ui64matrix_swp64_ilu3_elu2_red_factor(X, i + 0, j0, j1, Y);
    }
