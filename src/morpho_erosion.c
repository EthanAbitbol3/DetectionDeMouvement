...
// ---------------------------------------------------------------------------
{
    ...
    */
    ...
    for (j = j0; j <= ((j1 - 2) - r); j += 3)
    {
        ...
        a00 = load1(a0, j + 0); a10 = load1(a1, j + 0); a20 = load1(a2, j + 0);
        a01 = load1(a0, j + 1); a11 = load1(a1, j + 1); a21 = load1(a2, j + 1);
        a02 = load1(a0, j + 2); a12 = load1(a1, j + 2); a22 = load1(a2, j + 2); 
        ...
        // load
        a00 = load1(a0, j + 1); a10 = load1(a1, j + 1); a20 = load1(a2, j + 1);
        a01 = load1(a0, j + 2); a11 = load1(a1, j + 2); a21 = load1(a2, j + 2);
        a02 = load1(a0, j + 3); a12 = load1(a1, j + 3); a22 = load1(a2, j + 3);
